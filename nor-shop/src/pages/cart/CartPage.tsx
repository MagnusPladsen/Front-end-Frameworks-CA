...
export default function CartPage() {
  ...
  return (
    <div className="bg-white p-6 py-20 lg:py-10 lg:pb-20 lg:px-20 rounded flex flex-col lg:gap-20 gap-10 w-full lg:w-[800px] lg:mx-auto items-center justify-center">
      <h1 className="text-xl">Cart</h1>
      {cartItems.length === 0 ? (
        <p className="text-center">Your cart is empty</p>
      ) : (
        <div className="flex flex-col w-full lg:w-fit gap-10">
          {cartItems.map((item) => (
